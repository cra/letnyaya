...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.site_link'
        db.add_column('workshops_workshop', 'site_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Workshop.blog_link'
        db.add_column('workshops_workshop', 'blog_link', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workshop.site_link'
        db.delete_column('workshops_workshop', 'site_link')

        # Deleting field 'Workshop.blog_link'
        db.delete_column('workshops_workshop', 'blog_link')
    ...
    models = {
        ...
        'workshops.workshop': {
            ...
            'blog_link': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'site_link': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
