...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workshops_application', (
            ...
            ('is_interviewed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('workshops', ['Application'])


    def backwards(self, orm):
        
        # Deleting model 'Application'
        db.delete_table('workshops_application')
