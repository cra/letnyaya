...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.twitter'
        db.add_column('workshops_workshop', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Workshop.vk_group'
        db.add_column('workshops_workshop', 'vk_group', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Workshop.fb_group'
        db.add_column('workshops_workshop', 'fb_group', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workshop.twitter'
        db.delete_column('workshops_workshop', 'twitter')

        # Deleting field 'Workshop.vk_group'
        db.delete_column('workshops_workshop', 'vk_group')

        # Deleting field 'Workshop.fb_group'
        db.delete_column('workshops_workshop', 'fb_group')
