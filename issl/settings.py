# Django settings for issl project.
...
MEDIA_ROOT = '/home/letnyaya/public_html/media'
...
STATIC_ROOT = "/home/letnyaya/public_html/static"
...
STATICFILES_DIRS = (
    ...
    ("admin_media", os.path.join(PROJECT_DIR, 'static', 'admin_media')),
)
...
TEMPLATE_DIRS = (
    os.path.join(conf.ROOT, 'templates'),
)
...
MAIL_CODA = conf.MAIL_CODA
BCC_LIST = conf.BCC_LIST
