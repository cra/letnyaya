...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.comment'
        db.add_column('applications_applicant', 'comment', self.gf('django.db.models.fields.TextField')(default=u'No comments yet', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.comment'
        db.delete_column('applications_applicant', 'comment')
